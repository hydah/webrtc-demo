...
protected:
 ...
 public:
  ...
  static void Release();
  bool init(rtc::Thread *worker_thread,PeerConnectionStream* peerconnect);
...
{
public:
	VideoManagerImpl(PeerConnectionStream* livePusher);
...
private:
	...
	PeerConnectionStream *m_livePusher = nullptr;
};
